...
/**
 * Thread demo showing the following: - construction of a 2D string made from
 * particles and springs/sticks using the ParticleString2D class - dynamic
 * locking & unlocking of particles
 *
...
public class ThreadDemo extends PApplet {
    ...
    public static void main(String args[]) {
        PApplet.main(new String[]{"--present", "com.salaboy.rolo.ui.ThreadDemo"});
    }
}
