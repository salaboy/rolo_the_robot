...
//
///**
// * Thread demo showing the following: - construction of a 3D string made from
// * particles and springs/sticks - dynamic locking & unlocking of particles -
...
//import toxi.math.*;
//
//public class ThreadSphere extends PApplet {
//
...
//        physics.addBehavior(new GravityBehavior(new Vec3D(0.5f, 0.5f, 0.5f)));
...
//            if (prev != null) {
//                physics.addSpring(new VerletSpring(prev, p, REST_LENGTH, 0.5f));
//            }
//            prev = p;
//        }
...
//        // and world bounds
//        sphere(physics.getWorldBounds().getExtent().x * 2);
...
//        PApplet.main(new String[]{"--present", "com.salaboy.rolo.ui.ThreadSphere"});
//    }
//}
